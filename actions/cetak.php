...
<html>
    ...
    <body class="c3">
        ...
        <?= date("d-m-Y", strtotime($izinDetail['tanggal_keluar']))." pukul ".$izinDetail['jam_keluar'] ?>
    </span></p></td><td class="c7" colspan="1" rowspan="1"><p class="c2"><span class="c6">
    <?= date("d-m-Y", strtotime($izinDetail['tanggal_kembali']))." pukul ".$izinDetail['jam_kembali'] ?>
